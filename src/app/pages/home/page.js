...
import Preloader from "@/app/componetns/preloader/preloader";
...
export default function HomePage ({}) {
  ...
  useGSAP(() => {
	...
	useGSAP(() => {
		const panels = gsap.utils.toArray(["#home_background_container", "#growing_businesses"]);
    panels.forEach((panel, i) => {
      ScrollTrigger.create({
        ...
        pinSpacing: false,
        onUpdate: () => {
          if (i === 1) gsap.set("#growing_businesses", { y: '-90px' });
        }
      });
    });

    animateTextSplit("#growing_businesses_text", "#growing_businesses");
    animateTextSplit("#consistent_leads_header", "#consistent_leads");
    animateTextSplit(".trusted_partner_heading", "#trusted_partner");

		animateItems(".consistent_leads_text--anim-simple", "#growing_businesses", {
      duration: 1,
      opacity: 1,
			delay: 0.3,
      ease: "power2.out",
		...
		animateItems(".consistent_leads__descr", "#consistent_leads", {
      duration: 1,
      opacity: 1,
			delay: 0.3,
      ease: "power2.out",
    ...
    animateItems(".candle", "#consistent_leads", {
      duration: 1,
      yPercent: -100,
      ease: "power4.out",
      stagger: { each: 0.1 },
    ...
    animateItems(".progress__item_animated", ".progress__item_animated", {
      duration: 1,
      xPercent: 100,
      ease: "power2.out",
      stagger: { each: 0.3 },
    ...
    animateItems(".progress__item_text", ".progress__item_animated", {
      duration: 1,
      opacity: 1,
      delay: 0.1,
			scrollTrigger: {
    ...
    animateItems(".trusted_partner_text--anim-simple", "#trusted_partner", {
      duration: 1,
      opacity: 1,
      ease: "power2.out",
    });
	...
	const animateItems = (selector, trigger, props) => {
		gsap.to(selector, {
			...props,
			scrollTrigger: {
				trigger,
	...
	const animateTextSplit = (selector, triggerSelector) => {
    ...
    <main className={styles.main} ref={container}>
			...
			<section className={styles.growing_businesses} id="growing_businesses">
				...
				<div className={styles.growing_businesses__content} id="growing_businesses__content">
					...
					<div className={styles.growing_businesses__content__text_2+" consistent_leads_text--anim-simple"}>
			...
			<section className={styles.consistent_leads} id="consistent_leads">
				...
				<p className={styles.consistent_leads__descr+" consistent_leads__descr"}>
